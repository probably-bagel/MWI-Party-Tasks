...
(function () {
    ...
    function extractTasksFromBoard() {
        ...
        taskElements.forEach(taskEl => {
            ...
            // NEW: get the icon URL from the task name section
    ...
    function areTasksSimilar(oldTasks, newTasks) {
        ...
        for (let i = 0; i < newTasks.length; i++) {
            ...
            if (delta >= newTask.total * 0.4) {
                // 40% or more progress difference
                return false;
            }
        }

        return true; // no major changes
    }
    ...
    function uploadTasks(username, tasks) {
        ...
        GM_xmlhttpRequest({
            ...
            data: JSON.stringify({ user: username, tasks }),
            onload: res => {
